                    	...
                    	<tbody>
                            ...
                            @if(Auth::user()->hasRole('editor')||Auth::user()->hasRole('admin'))
                              ...
                              @elseif(Auth::user()->hasRole('author'))
                                   ...
                                   @else
                                   <a href="{{route('blog.edit',$post->id)}}" class="disabled btn btn-xs btn-default"><i class="fa fa-edit"></i></a>
                                   <button type="submit" class="disabled btn btn-xs btn-danger"><i class="fa fa-times"></i></button>
                                   @endif
                              @endif
                            {!!Form::close()!!}
                    			</td>
